...
public class NNBenchDD {
  private static final Log LOG = LogFactory.getLog(NNBenchDD.class);
  ...
  protected static final String DEFAULT_RES_FILE_NAME = "NNBenchDD_results.log";
  protected static final String NNBENCH_VERSION = "NameNode Benchmark didi_0.4";
  ...
  public static long blockSize = 1*1024*1024l; // default is 1M
  ...
  public static int numberOfThreads = 1; // default is 1
  public static short replicationFactorPerFile = 1; // default is 1
  public static String baseDir = "/benchmarks/NNBenchDD";  // default
  ...
  private static void createControlFiles() throws IOException {
    ...
    for (int i = 0; i < numberOfMaps; i++) {
      String strFileName = "NNBenchDD_Controlfile_" + i;
  ...
  private static void displayUsage() {
    String usage =
            "Usage: nnbench <options>\n" +
                    ...
                    "\t-blockSize <Block size in bytes. default is 1M. " +
                    ...
                    "This is not mandatory>\n" +
                    "\t-numberOfThreads <number of threads per map. default is 1.>" +
                    "This is not mandatory>\n" +
  ...
  public static void parseInputs(final String[] args) {
    ...
    LOG.info("Number of threads per map: " + numberOfThreads);
    ...
    config.setInt("test.nnbench.numberofthreads", numberOfThreads);
  ...
  public static void runTests() throws IOException {
    ...
    job.setJobName("NNBenchDD-" + operation);
    ...
    job.setMapperClass(NNBenchDDMapper.class);
    job.setReducerClass(NNBenchDDReducer.class);
   ...
   * Mapper class
   */
  static class NNBenchDDMapper extends Configured
    ...
    private class BenchThread extends Thread {
      ...
      public int numOfExceptions = 0;
      public long startTimeAL = 0l;
      public long totalTimeAL1 = 0l;
      public long totalTimeAL2 = 0l;
      public long successfulFileOps = 0l;

      public BenchThread(int id, String prefix, Reporter reporter) {
        this.id = id;
        this.prefix = prefix;
        this.reporter = reporter;
        this.setName("BenchThread#" + id);
      }
    ...
    public void map(Text key,
      ...
      numberOfThreads = conf.getInt("test.nnbench.numberofthreads", 1);
      ...
      if (barrier()) {
        ...
        // create threads.
        BenchThread[] threads = new BenchThread[numberOfThreads];
        for (int i = 0; i < numberOfThreads; i++) {
          threads[i] = new BenchThread(i, fileName, reporter);
        }
        ...
        for (BenchThread thread : threads) {
          ...
          totalTimeAL1 += thread.totalTimeAL1;
          totalTimeAL2 += thread.totalTimeAL2;
          numOfExceptions += thread.numOfExceptions;
          successfulFileOps += thread.successfulFileOps;
        }
   ...
   * Reducer class
   */
  static class NNBenchDDReducer extends MapReduceBase
          implements Reducer<Text, Text, Text, Text> {

    protected String hostName;

    public NNBenchDDReducer () {
